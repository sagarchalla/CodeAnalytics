...
public class StringProblems {
    ...
    private static int startIndex;
         ...
         public static String maskify(String str) {
            ...
            // check if the str length is greater than 4
            if(str != null && str.length() > 4){
                String lastChars = str.substring(str.length() - 4, str.length());

                for(int i = 0; i < str.length() - 4; i++){
                    sb.append("#");
                }
                return sb.append(lastChars).toString();
            }
            else {
                return str;
            }
